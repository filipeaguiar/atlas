...
- [x] 6.5 Acionar e acompanhar o primeiro workflow com `gh`, corrigindo falhas do build sem relaxar as regras editoriais
- [x] 6.6 Revisar o site implantado, seus assets, navegação, URL de subdiretório e ausência de áreas internas
