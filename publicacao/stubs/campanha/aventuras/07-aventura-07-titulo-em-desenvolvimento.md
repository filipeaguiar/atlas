---
id: aventura-07
titulo: "Aventura 07 — título em desenvolvimento"
tipo: aventura
status: stub-gerado
publicar: false
arco: 2
funcao: "inaugurar os Chamados reais e a atuação com licença provisória"
---

# Aventura 07 — título em desenvolvimento

> Documento interno de preparação. Não entra na publicação enquanto `publicar` permanecer falso.

**Arco:** 2  
**Função estrutural:** inaugurar os Chamados reais e a atuação com licença provisória.
