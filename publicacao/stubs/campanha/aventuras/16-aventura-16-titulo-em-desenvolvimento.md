---
id: aventura-16
titulo: "Aventura 16 — título em desenvolvimento"
tipo: aventura
status: stub-gerado
publicar: false
arco: 2
funcao: "concluir o arco, conceder a licença definitiva e confirmar uma ameaça maior"
---

# Aventura 16 — título em desenvolvimento

> Documento interno de preparação. Não entra na publicação enquanto `publicar` permanecer falso.

**Arco:** 2  
**Função estrutural:** concluir o arco, conceder a licença definitiva e confirmar uma ameaça maior.
