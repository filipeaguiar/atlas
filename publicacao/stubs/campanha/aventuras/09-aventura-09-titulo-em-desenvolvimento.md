---
id: aventura-09
titulo: "Aventura 09 — título em desenvolvimento"
tipo: aventura
status: stub-gerado
publicar: false
arco: 2
funcao: "aprofundar relações e autonomia sem tornar o metaplot obrigatório"
---

# Aventura 09 — título em desenvolvimento

> Documento interno de preparação. Não entra na publicação enquanto `publicar` permanecer falso.

**Arco:** 2  
**Função estrutural:** aprofundar relações e autonomia sem tornar o metaplot obrigatório.
