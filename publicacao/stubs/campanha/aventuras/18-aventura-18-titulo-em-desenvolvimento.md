---
id: aventura-18
titulo: "Aventura 18 — título em desenvolvimento"
tipo: aventura
status: stub-gerado
publicar: false
arco: 3
funcao: "realizar a quarta operação de captura, retirar a Vanguarda ativa e apontar para Multiplex"
---

# Aventura 18 — título em desenvolvimento

> Documento interno de preparação. Não entra na publicação enquanto `publicar` permanecer falso.

**Arco:** 3  
**Função estrutural:** realizar a quarta operação de captura, retirar a Vanguarda ativa e apontar para Multiplex.
