---
id: aventura-15
titulo: "Aventura 15 — título em desenvolvimento"
tipo: aventura
status: stub-gerado
publicar: false
arco: 2
funcao: "mostrar as consequências da segunda operação e fortalecer a ligação com a Tragédia de Belamar"
---

# Aventura 15 — título em desenvolvimento

> Documento interno de preparação. Não entra na publicação enquanto `publicar` permanecer falso.

**Arco:** 2  
**Função estrutural:** mostrar as consequências da segunda operação e fortalecer a ligação com a Tragédia de Belamar.
