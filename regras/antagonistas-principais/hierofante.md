...
### Tesouro
**Códice Inquisitorial:** Um pequeno livro de dogmas acorrentado. Ao ser estudado, permite a um herói usar a perícia *Influência* para comandar (debuffar) capangas comuns inimigos, forçando-os a obedecer pequenas "leis" por um turno (ex: "Joguem as armas no chão").
