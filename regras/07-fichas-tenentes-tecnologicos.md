...
## Nexo
*O Infiltrador Digital*

**12 pt**

Nexo não é exatamente uma pessoa, mas uma rede de drones humanoides conectados a uma única mente de processamento veloz. Ele não luta fisicamente quando pode evitar; prefere hackear o ambiente, os trajes e os dispositivos dos alunos do Instituto Atlas para desorientá-los. Ele fala por vários drones ao mesmo tempo, sempre com uma voz metálica e polida.
...
Se Nexo é o cérebro, Bastião é a parede. Uma armadura de contenção gigantesca e pesada, criada para controle de multidões e para impedir que heróis invadam complexos restritos. É lento, suas falas são compostas de sirenes e avisos pré-gravados de "Afastem-se do perímetro", mas seus golpes e sua defesa são avassaladores.
...
## Contramedida
*A Assassina Adaptativa*

**14 pt**

Projetada especificamente para caçar Extraordinários. A armadura de Contramedida possui nanotecnologia reativa que analisa os padrões de ataque de seus inimigos e se adapta em tempo real. Ela é silenciosa, metódica e sempre parece um passo à frente.
...
## Rastro
*O Batedor Implacável*

**12 pt**

Rastro é uma unidade de busca e destruição furtiva, equipada com camuflagem óptica e pernas que permitem saltos imensos. Ele persegue Extraordinários fujões ou isolados. É o terror dos alunos do Atlas quando se separam em vielas ou ruínas. 
