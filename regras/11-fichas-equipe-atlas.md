---
id: fichas-equipe-atlas
titulo: "Fichas da equipe do Instituto Atlas"
tipo: ficha
categoria: npcs-atlas
camada: mestre
...
aprovado: true
fontes_fatuais:
  - campanha/aventuras/01-exame-de-admissao.md
  - campanha/01-premissa-e-tom.md
---

# Fichas da equipe do Instituto Atlas

Estas fichas transformam funções já apresentadas em recursos de mesa. Adultos do Atlas abrem espaço, protegem e orientam; os Objetivos decisivos continuam com os personagens dos jogadores.

## Beatriz Leal — coordenação de ingresso

**10 pt — apoio institucional.** Beatriz organiza pessoas, rotas e necessidades sem transformar acolhimento em burocracia.
...
**Interpretação:** rápida, atenta e acolhedora; pergunta antes de presumir.

## Álvaro Siqueira — direção e legado

**19 pt — veterano de contenção.** Álvaro sustenta crises e coordena prioridades com a autoridade de quem conhece o custo de uma decisão tardia.
...
**Interpretação:** voz baixa, postura firme e nenhuma pressa em ocupar o centro da cena.

## Dalva Menezes — avaliação e protocolo

**11 pt — controle de operação.** Dalva transforma procedimentos em escolhas compreensíveis e reconhece quando uma regra precisa parar a situação.
...
## Dra. Samira Nasser — saúde e recomposição

**12 pt — suporte médico.** Samira identifica exaustão, estabiliza recursos e protege a autonomia de quem recebe cuidado.
...
**Interpretação:** observa antes de tocar e sempre explica o que pretende fazer.

## Lívia Monteiro — Métrica

**14 pt — controle e repetição.** Métrica identifica variações mínimas e ensina heróis a reconhecer o próprio limite.
...
**Interpretação:** perguntas curtas, movimentos econômicos e elogios específicos.

## Caio Ventura — Impacto

**15 pt — força e disciplina.** Impacto demonstra que potência útil começa por posição, aviso e controle.
...
**Interpretação:** sorriso aberto, voz que atravessa o ginásio e correções sem humilhação.

## Janaína Rocha — Âncora

**16 pt — proteção e segurança.** Âncora mantém rotas abertas e impede que pressão ambiental desfaça a equipe.
...
**Interpretação:** firme, audível e previsível; segurança nunca é tratada como covardia.

## Raul Farias — Vestígio

**14 pt — investigação de campo.** Raul lê marcas, resíduos e alterações que outras pessoas descartam.
...
**Interpretação:** fala baixo, aponta detalhes e deixa silêncio suficiente para alguém perceber.

## Tomás Valença — Multiplex

> **Segredo do Mestre:** Tomás é Multiplex, sobrevivente da Vanguarda. Não revele essa ficha antes de a campanha produzir a descoberta.

**20 pt — veterano de coordenação.** Tomás divide presença e atenção entre duplicatas, mas evita usar o legado para decidir pelos alunos.
...
**Interpretação:** discreto, paciente e sempre interessado no que os alunos perceberam antes de dizer o que ele sabe.
