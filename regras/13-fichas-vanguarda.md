---
id: fichas-vanguarda
titulo: "Fichas da Vanguarda"
tipo: ficha
categoria: npcs-vanguarda
camada: mestre
...
A Vanguarda é uma geração veterana. Use estas fichas para memória, treinamento, resgate ou operações em que os veteranos são alvos. Eles criam oportunidades; a nova geração toma as decisões que encerram a campanha.
...
**20 pt — coordenação distribuída.** Use o bloco completo de **Tomás Valença — Multiplex** em [Fichas da equipe do Instituto Atlas](11-fichas-equipe-atlas.md#tomás-valença--multiplex).

**Função na Vanguarda:** duplicatas mantêm comunicação, oferecem Ajuda e cobrem pontos simultâneos. Elas não concluem o Objetivo Maior pelos personagens.
...
## Usando a equipe sem retirar protagonismo

Em cenas com a Vanguarda, atribua ao veterano uma pressão paralela: sustentar estrutura, conter reforços, proteger civis ou manter comunicação. O Objetivo que muda a história — interpretar a pista, escolher o alvo, impedir a operação ou decidir o futuro do legado — pertence aos personagens dos jogadores.
